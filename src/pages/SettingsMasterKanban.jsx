        ...
        <header className="mb-8 flex items-start gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-slate-500 mt-1">
              Source of truth: <code className="text-slate-700 bg-slate-100 px-1.5 py-0.5 rounded">components/master-kanban/</code> · Current version <code className="text-slate-700 bg-slate-100 px-1.5 py-0.5 rounded">v0.1.3</code>
            </p>
          </div>
        </header>
