...
import { Sparkles, Phone, Mail, Users, Star, Loader2, User as UserIcon } from 'lucide-react';
...
// The analytics body (metrics, trend chart, AI summary) without a Dialog wrapper,
// so it can be embedded in the split Insights modal or the standalone modal.
