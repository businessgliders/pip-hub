...
export default function InboxTopBar({ view, setView, currentUser, openCount = 0, counts = {}, onOpenThread, hideChatWidgets = false }) {
  ...
  return (
    <>
    <header className="safe-top shrink-0 px-2 md:px-4 pt-7 pb-1.5 min-h-[62px] flex items-center gap-1.5 md:gap-4 bg-white/30 dark:bg-black/30 backdrop-blur-xl border-b border-white/40 dark:border-white/10">
