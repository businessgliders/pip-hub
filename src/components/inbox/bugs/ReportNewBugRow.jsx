...
export default function ReportNewBugRow({ onClick }) {
  return (
    <button
      onClick={onClick}
      className="w-full text-left mx-2 my-1 px-3 py-3 flex gap-3 rounded-2xl transition-all border border-white/15 bg-[#6b4a3a]/80 backdrop-blur-md hover:bg-[#5a3a2e]/85 shadow-md"
