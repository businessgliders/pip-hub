...
export default function ReportNewBugRow({ onClick }) {
  return (
    <button
      onClick={onClick}
      className="w-full text-left mx-2 my-1 px-3 py-3 flex gap-3 rounded-2xl transition-all border-l-[3px] border-transparent bg-[#5a3a2e] hover:bg-[#4a2f25] shadow-md"
