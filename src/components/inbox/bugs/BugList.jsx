  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="px-4 pt-4 pb-2 shrink-0 flex items-center justify-between gap-2">
        <h2 className="text-lg font-bold text-[#7d2235] dark:text-white flex items-center gap-2">
          PiP Bugs
          <span className="text-xs font-semibold px-2 py-0.5 rounded-full bg-[#7d2235]/10 text-[#7d2235] dark:bg-white/10 dark:text-white/80">
            {filtered.length}
          </span>
        </h2>
