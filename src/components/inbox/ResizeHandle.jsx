...
export default function ResizeHandle({ onDrag }) {
  ...
  return (
    <div
      ...
      className="hidden md:block w-1.5 shrink-0 cursor-col-resize rounded-full bg-transparent hover:bg-pink-300/50 active:bg-pink-400/70 transition-colors z-10"
